...
export default function HostAllListings() {
  ...
  const fetchListings = async () => {
    const response = await fetch("https://wanderlust-1-s261.onrender.com/api/HostAllListings", {
      credentials: "include",
    });
  ...
  const deleteListing = async (listingId) => {
    const res = await fetch(`https://wanderlust-1-s261.onrender.com/api/delete/${listingId}`, {
      method: "DELETE",
      credentials: "include",
    });

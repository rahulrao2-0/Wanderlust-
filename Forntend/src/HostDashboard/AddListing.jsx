...
export default function AddListing() {
  ...
  useEffect(() => {
    ...
    const Timer = setTimeout(async () => {
      const response = await fetch('https://wanderlust-1-s261.onrender.com/api/ai/generateDescription', {
        method: "POST",
        credentials: "include",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://wanderlust-1-s261.onrender.com/api/addListing', {
        method: 'POST',
        credentials: 'include',
        body: payload,
      });
